...
label_Website.grid(row=1, sticky=E, padx=10)
label_Username.grid(row=2, sticky=E, padx=10)
label_Password.grid(row=3, sticky=E, padx=10)

entry_Website.grid(columnspan=3, row=1, column=1, padx=10, pady=2, sticky=W)
entry_Username.grid(columnspan=3, row=2, column=1, padx=10, pady=2, sticky=W)
entry_Password.grid(columnspan=3, row=3, column=1, padx=10, pady=2, sticky=W)

saveBtn.grid(columnspan=3, padx=50, pady=4, ipadx=30)

label_website2 = Label(window, text='Name: ', font = ('Roboto', 12), fg="cadetblue4", justify=CENTER)
label_username2 = Label(window, text='Email: ', font = ('Roboto', 12), fg="cadetblue4", justify=CENTER)
label_password2 = Label(window, text='Password: ', font = ('Roboto', 12), fg="cadetblue4", justify=CENTER)

label_website2 .grid(row=5, column=0)
label_username2.grid(row=5, column=1)
label_password2.grid(row=5, column=2, padx=20)
